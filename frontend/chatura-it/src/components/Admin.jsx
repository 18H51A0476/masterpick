...
import { PeopleAlt, BatchPrediction, School,Functions} from '@mui/icons-material';
    ...
    <div style={{
      ...
      {loading ? (
        ...
        <div style={{
          ...
          <Card component={Link} to="/problem-management" style={{
            flex: 'calc(50% - 16px)', // Two cards per row with space in between
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
            ...
            <CardContent style={{
              ...
              <Functions style={{ fontSize: '48px', marginBottom: '8px' }} />
              <Typography variant="h6" gutterBottom>
                Problem Management
              </Typography>
            </CardContent>
