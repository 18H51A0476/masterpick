...
const courses = [
  ...
  { title: 'C++ Programming', description: 'Explore the world of C++ programming.' },
  { title: 'Java Programming', description: 'Master Java programming language.' },
  { title: 'Python Programming', description: 'Dive into Python programming language.' },
];
  ...
  return (
      <Container maxWidth="md">
        <Box mt={5} textAlign="center">
          <Typography variant="h2" component="h1" gutterBottom style={{ fontFamily: 'Montserrat, sans-serif' }}>
          ...
          <Typography variant="body1" paragraph style={{ fontFamily: 'Montserrat, sans-serif' }}>
